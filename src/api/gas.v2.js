 ...
 */
const GAS_URL = 'https://script.google.com/macros/s/AKfycbwzCkqixN1VUK-knKWkW4KhbU30GUi0BbZRo9hBwpuDCWsV8mQditT_Qh48oqrBLgu86A/exec'; // Updated to deployment @23
...
const gasApi = {
    ...
    async post(action, data) {
        try {
            ...
            console.log("GAS_URL is:", GAS_URL);
